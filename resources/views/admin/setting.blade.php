        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper mt-50">
                    <h5 class="hk-sec-title">Update Admin Email</h5>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <form action="{{ route('admin.update.setting') }}" method="post"
                                ...
                                @csrf
                                <input type="hidden" name="user_id" value="{{ $admin[0]->id }}">
                                <div class="form-group row">
                                    <label for="inputName" class="col-sm-4 col-form-label">Name</label>
                                    <div class="col-sm-8">
                                        <input type="Name" class="form-control" id="inputName" name="name"
                                            value="{{ $admin[0]->name }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="email" class="form-control" id="inputEmail3" name="email"
                                            value="{{ $admin[0]->email }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputAreas" class="col-sm-4 col-form-label">Password</label>
                                    <div class="col-sm-8">
                                        <input type="password" class="form-control" id="inputAreas" name="password"
                                            value="" required>
                                    </div>
                                </div>
