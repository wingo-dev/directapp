                    ...
                    <div class="row">
                        <div class="col-sm">
                            <form action="{{ route('admin.owner.update') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="user_id" value="{{$owner[0]->id}}">
                                <div class="form-group row">
                                    <label for="inputName" class="col-sm-4 col-form-label">Name</label>
                                    <div class="col-sm-8">
                                        <input type="Name" class="form-control" id="inputName" name="name" value="{{ $owner[0]->name }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 col-form-label">Email</label>
                                    <div class="col-sm-8">
                                        <input type="email" class="form-control" id="inputEmail3" name="email" value="{{ $owner[0]->email }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary">Update site owner</button>
                                    </div>
                                </div>
                            </form>
                        </div>
