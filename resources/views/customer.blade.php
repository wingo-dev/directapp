                    ...
                    <div class="col-sm">
                        <form action="{{ route('add.listing') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" id="inputGraduation" name="graduation" placeholder="Undergraduate Institution & Graduation Year">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputLaw" class="col-sm-4 col-form-label">Law School & Graduation Year</label>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" id="inputLaw" name="law" placeholder="Law School & Graduation Year">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputBar" class="col-sm-4 col-form-label">Bar Admission State and Year</label>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" id="inputBar" name="bar" placeholder="Bar Admission State and Year">
                                </div>
                            </div>
                            <div class="form-group row">
